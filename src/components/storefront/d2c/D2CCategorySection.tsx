        ...
        <div className="flex gap-4 lg:gap-8 overflow-x-auto pb-6 scrollbar-hide -mx-4 px-4 lg:mx-0 lg:px-0 lg:flex-wrap lg:justify-center">
          {categories.map((category, index) => {
            ...
            return (
              ...
              >
                <div className="w-[84px] h-[84px] lg:w-[120px] lg:h-[120px] rounded-full overflow-hidden transition-transform group-hover:scale-105 mb-2 lg:mb-3 flex items-center justify-center relative bg-neutral-50/50">
                  <img
                    src={imageUrl}
                    alt={category.name}
