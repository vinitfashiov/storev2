...
export function D2CBrandSection({
    ...
    return (
        <section className="py-3 lg:py-8 bg-white">
            <div className="max-w-7xl mx-auto px-4 lg:px-8">
                ...
                <div className="flex gap-3 lg:gap-8 overflow-x-auto pb-4 scrollbar-hide -mx-4 px-4 lg:mx-0 lg:px-0 lg:flex-wrap lg:justify-center">
                    {brands.map((brand) => {
                        ...
                        return (
                            ...
                            >
                                <div className="w-[80px] h-[80px] lg:w-[120px] lg:h-[120px] rounded-full overflow-hidden transition-transform group-hover:scale-105 mb-2 lg:mb-3 flex items-center justify-center relative bg-neutral-50 border border-neutral-100 p-2">
                                    {imageUrl ? (
                                        <img
                                            src={imageUrl}
                                            alt={brand.name}
