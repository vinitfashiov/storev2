...
import { Smartphone, Download, Copy, Check, ExternalLink, QrCode } from 'lucide-react';
...
export function StorefrontPWACard({ storeSlug, storeName }: StorefrontPWACardProps) {
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <Button 
            className="flex-1 gap-2"
            onClick={() => {
              // Open storefront on mobile to trigger install
              window.open(storefrontUrl, '_blank');
